...
enum SMART_ACTION
{
    ...
    SMART_ACTION_SPAWN_CREATUREGROUP                = 116,    // Group ID, min secs, max secs
    SMART_ACTION_DESPAWN_CREATUREGROUP              = 117,    // Group ID, min secs, max secs
    SMART_ACTION_SPAWN_GAMEOBJECTGROUP              = 118,    // Group ID, min secs, max secs
    SMART_ACTION_DESPAWN_GAMEOBJECTGROUP            = 119,    // Group ID, min secs, max secs

    SMART_ACTION_END                                = 120
};
